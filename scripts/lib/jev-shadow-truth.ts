...
export const PROTECTED_GLOB_CATEGORIES: Record<string, ProtectedCategory> = {
  ...
  'apps/product/src/features/external-calendar/server/google-oauth.ts': 'external-calendar',
  'apps/product/src/features/external-calendar/server/authority-config.ts': 'external-calendar',
  'apps/product/src/features/external-calendar/server/connect-flow.ts': 'external-calendar',

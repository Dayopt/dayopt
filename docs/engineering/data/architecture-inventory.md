...
| DB テーブル    | `cron_heartbeats`                                                 | `supabase/migrations`                                                                                                             | used by lib                  |
| DB テーブル    | `email_suppressions`                                              | `supabase/migrations`                                                                                                             | used by app, lib             |
| DB テーブル    | `mcp_environment_identity`                                        | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `mcp_mutation_control`                                            | `supabase/migrations`                                                                                                             | used by lib                  |
| DB テーブル    | `mcp_mutation_receipts`                                           | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `mfa_recovery_codes`                                              | `supabase/migrations`                                                                                                             | used by auth                 |
| DB テーブル    | `oauth_audit_log`                                                 | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `oauth_authorization_codes`                                       | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `oauth_connections`                                               | `supabase/migrations`                                                                                                             | used by lib, settings        |
| DB テーブル    | `oauth_tokens`                                                    | `supabase/migrations`                                                                                                             | used by lib                  |
| DB テーブル    | `product_events`                                                  | `supabase/migrations`                                                                                                             | used by lib                  |
| DB テーブル    | `reports`                                                         | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `stripe_webhook_events`                                           | `supabase/migrations`                                                                                                             | used by app, settings        |
| DB テーブル    | `undo_receipt_effects`                                            | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `undo_receipt_field_changes`                                      | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `undo_receipts`                                                   | `supabase/migrations`                                                                                                             | app からの直接アクセスなし   |
| DB テーブル    | `write_fence_control`                                             | `supabase/migrations`                                                                                                             | used by lib                  |
...
| DB 関数        | `begin_account_deletion_v1`                                       | `supabase/migrations`                                                                                                             | used by app                  |
| DB 関数        | `begin_calendar_oauth_attempt_v1`                                 | `supabase/migrations`                                                                                                             | app からの .rpc 呼び出しなし |
| DB 関数        | `bind_billing_account_deletion_v1`                                | `supabase/migrations`                                                                                                             | used by app                  |
| DB 関数        | `bind_calendar_account_deletion_v1`                               | `supabase/migrations`                                                                                                             | used by app                  |
| DB 関数        | `cancel_calendar_account_deletion_v1`                             | `supabase/migrations`                                                                                                             | app からの .rpc 呼び出しなし |
| DB 関数        | `claim_account_deletion_step_v1`                                  | `supabase/migrations`                                                                                                             | used by app                  |
...
| DB 関数        | `cleanup_billing_account_deletion_terminal_receipts_v2`           | `supabase/migrations`                                                                                                             | used by settings             |
...
| DB 関数        | `complete_account_deletion_step_v1`                               | `supabase/migrations`                                                                                                             | used by app                  |
...
| DB 関数        | `get_account_deletion_customer_recovery_v1`                       | `supabase/migrations`                                                                                                             | used by settings             |
...
| DB 関数        | `seal_account_deletion_v1`                                        | `supabase/migrations`                                                                                                             | used by app                  |
| DB 関数        | `seal_billing_account_deletion_v1`                                | `supabase/migrations`                                                                                                             | used by app                  |
...
| tRPC procedure | `user.deleteAccount`                                              | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |
| tRPC procedure | `user.deleteAllData`                                              | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |
| tRPC procedure | `user.deleteBlocks`                                               | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |
| tRPC procedure | `user.exportData`                                                 | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |
| tRPC procedure | `user.requestEmailChange`                                         | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |
| tRPC procedure | `user.verifyRecoveryCode`                                         | `apps/product/src/features/auth/server/router.ts`                                                                                 | protectedProcedure           |

...
| `/[locale]/calendar`            | 27  | `activities.listActivities`, `activities.listCategories`, `activities.listTree`, `billing.getAccess`, `billing.getOverview`, `billing.startTrial`, `externalCalendar.listEvents`, `planCommands.create`, `planCommands.delete`, `planCommands.restore`, `planCommands.update`, `planTemplates.applyToDay`, `planTemplates.create`, `planTemplates.delete`, `planTemplates.list`, `planTemplates.rename`, `plans.getById`, `plans.list`, `recordCommands.create`, `recordCommands.delete`, `recordCommands.restore`, `recordCommands.update`, `records.getById`, `records.list`, `statistics.getActivityStats`, `userSettings.get`, `userSettings.update` |

...
- Your spam folder
- `noreply@dayopt.app` is on your allow list
...
2. Type `DELETE`. If your account has a password, enter it. If you sign in with Google and have two-step verification turned on, enter the code from your authenticator app instead. If you have neither, typing `DELETE` is all that is asked for
3. Press "Execute deletion". Your account is removed immediately, and a notice is sent to your email address afterwards

**Note:**

- Deletion can't be undone
- Any active subscription is cancelled as part of the deletion. You do not need to cancel it first
